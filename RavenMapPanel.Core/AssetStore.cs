...
internal static class AssetStore
{
    ...
    public static List<MonumentRule> LoadCatalog()
    {
        ...
        foreach (var item in root.EnumerateArray())
        {
            ...
            var generatorControl = S(item, "generator_control");
            result.Add(new MonumentRule {
                ...
                IsWorldFeature = generatorControl is "world_powerlines" or "world_metro" or "unique_lakes" or "unique_canyons" or "unique_oases"
            });
        }
    ...
    public static (string FileName, int Width, int Height) ImportCustomIcon(string sourcePath, string ruleId)
    {
        ...
        Directory.CreateDirectory(SettingsStore.CustomIconsRoot);
