...
namespace CustomGenerator
{
    public class ExtConfig {
        ...
        private static readonly string CurrentVersion = "0.2.5-raven";
        ...
        private static void LoadConfig() {
            ...
            try {
                ...
                if (oldConfig == null) throw new InvalidDataException("Configuration JSON is empty or invalid.");
                ...
                if (oldConfig.Version != CurrentVersion) {
                    ...
                    if (oldConfig.Monuments != null) {
                        ...
                        Config.Monuments.monuments = oldConfig.Monuments.monuments ?? new List<Monument>();
                ...
                Config.Monuments ??= new MonumentSettings();
                Config.Monuments.monuments ??= new List<Monument>();
